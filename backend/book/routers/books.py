...
from book.schemas import BookListResponse, BookResponse, BookIn, BookStatsResponse, BooksByCategoryResponse, \
    BookCategory
...
@router.post("/{id}/", response={200: BookResponse, 400: ErrorResponse, 404: ErrorResponse})
