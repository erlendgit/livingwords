...
export function TruthListSelectForm({ids, onAdd, onRemove, onAddNew, onDone}: TruthListSelectProps) {
    ...
    return (
        <>
            {editing && <TruthUpdateForm truth={editing} onClose={handleShowList}/>}
            {!editing &&
                <TruthListSelectTab
                    ids={ids}
                    onAdd={onAdd}
...
export function TruthListSelectTab({ids, onAdd, onEdit, onRemove, onAddNew, onDone}: TruthListSelectTabProps) {
                    ...
                    columnCallbacks={[
                        ...
                        (truth: Truth) => (
                            <FlexWidget>
                                ...
                                <TextButtonWidget onClick={() => onEdit(truth)}>Edit</TextButtonWidget>
                            </FlexWidget>
                        ),
                    ]}/>
            )}
