...
export function StoryListSelect({
    ids,
    onAdd,
    onRemove,
    onClose,
    onClickAdd,
}: StoryListSelectProps) {
    ...
    return (
        <>
            {editing && (
                <StoryUpdateForm story={editing} onClose={handleShowList} />
            )}
            {!editing && (
                <StoryListSelectTab
                    ids={ids}
...
export function StoryListSelectTab({
    ids,
    onAdd,
    onEdit,
    onRemove,
                    ...
                    columnCallbacks={[
                        ...
                        (story: Story) => (
                            <>
                                ...
                                <TextButtonWidget onClick={() => onEdit(story)}>
                                    Edit
                                </TextButtonWidget>
                            </>
                        ),
